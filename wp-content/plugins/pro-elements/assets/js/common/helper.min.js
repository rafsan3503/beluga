...
function epObserveTarget(t, e) {
  ...
  (r.rootMargin = r.rootMargin || "10% 0px 0px 0px"),
    new IntersectionObserver(function (t, s) {
      t.forEach(function (t) {
        t.isIntersecting && (e(t), r.loop || s.unobserve(t.target));
      });
    }, r).observe(t);
}
...
jQuery,
  ...
  (function (t, e) {
    ...
    t(window).on("elementor/frontend/init", function () {
      const e = function (e) {
          jQuery(e).find(".bdt-ep-read-more-text").length &&
            jQuery(e)
              .find(".bdt-ep-read-more-text")
              .each(function () {
                var e = t(this).data("read-more").words_length || 20,
                  r = t(this).html().split(/\s+/);
                if (r.length > e) {
                  var s = r.slice(0, e).join(" "),
                    o = r.slice(e).join(" ");
                  t(this).html(
                    ...
                    t(this)
                      ...
                      .click(function (e) {
                        e.preventDefault(),
                          t(this).hide(),
                          t(this).siblings(".bdt_more_text").show(),
                          t(this).siblings("a.bdt_read_less").show();
                      }),
                    t(this)
                      ...
                      .click(function (e) {
                        e.preventDefault(),
                          t(this).hide(),
                          t(this).siblings(".bdt_more_text").hide(),
                          t(this).siblings("a.bdt_read_more").show();
                      });
                }
              });
        },
        r = {
          "bdt-review-card.default": e,
          "bdt-review-card-carousel.default": e,
          "bdt-review-card-grid.default": e,
        };
      t.each(r, function (t, e) {
        elementorFrontend.hooks.addAction("frontend/element_ready/" + t, e);
      });
    });
